...
def log_prior(theta, t_max):
    ...
    if not (0 < t_changes[0] < 15)&(30<t_changes[1]<43)&(80<t_changes[2]<230) &(240<t_changes[3]<260):
        return -np.inf
...
initial_betas=[1.5/14, 2/14, 1/28, 2/14, 1/56]



initial_t_changes = [10, 35, 120, 253]


gamma = 1/14

initial_sigma=[500, 500, 300, 2000, 2000]
...
base_filename = "5beta_inferr_sigma"
extension = ".h5"
