...
def log_prior(theta, t_max):
    ...
    if not (0 < t_changes[0] < 15)&(30<t_changes[1]<43)&(80<t_changes[2]<160) &(190< t_changes[3] < 230) &(240<t_changes[4]<260):
        return -np.inf
...
initial_betas=[1.5/14, 2/14, 1/28, 1/14, 2/14, 1/56]



initial_t_changes = [10, 37, 120, 220, 253]


gamma = 1/14

initial_sigma=[300, 300, 300, 500, 2000, 2000]
...
base_filename = "6beta_inferr_sigma"
extension = ".h5"
